...
const Register = () => {
	...
	return (
		<>
			<PageMeta
				titleKey="register.meta.title"
				descriptionKey="register.meta.description"
			/>
			<DefaultWrapper key={location.pathname}>
				<div className="grid min-h-svh xl:grid-cols-2">
					...
					<div className="border-l border-l-secondary-color hidden xl:block min-h-screen bg-primary">
